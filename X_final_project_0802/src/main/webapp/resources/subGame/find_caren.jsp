...
<style>
	#back {
    	...
    	margin-left: -535px;
    	margin-top: -330px;
    	background: url('/resources/subGame/image/caren_office.jpg');
...
<section>
        <article id="screen">
            ...
            <div id="back">
                <img class="clicker" id="smallLamp" src="/resources/subGame/image/lamp.png" onclick="lamp();">
                <img class="clicker" id="smallLetter" src="/resources/subGame/image/letter.png" onclick="letter();">
            </div>
